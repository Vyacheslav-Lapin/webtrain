 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://wsdl.web.java.lab.epam.com/", wsdlLocation = "http://localhost:1212/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://wsdl.web.java.lab.epam.com/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://wsdl.web.java.lab.epam.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsdl.web.java.lab.epam.com/", "HelloPort"), Hello.class, features);
    }
